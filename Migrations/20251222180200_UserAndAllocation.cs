...
{
    /// <inheritdoc />
    public partial class UserAndAllocation : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllocationType = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EmployeeAllocations_Employees_EmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeAllocations_EmployeeId",
